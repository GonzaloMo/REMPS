...
from SimpleSatellite.envs.setgoals.v2 import Simple_satellite as Simple_satellite_setgoals_v2_2
from SimpleSatellite.envs.setgoals.CV_learning import CurriculumEnv as Simple_satellite_setgoals_v2_cv
