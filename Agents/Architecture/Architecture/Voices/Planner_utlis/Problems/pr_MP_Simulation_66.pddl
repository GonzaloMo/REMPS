...
(image_analysed mem0 img19)
  ...
  (at 46 (image_available img8))
  (at 54 (not (image_available img8)))
  (at 0 (image_available img9))
  (at 0 (not (image_available img9)))
  ...
  (at 6 (image_available img21))
  (at 14 (not (image_available img21)))
  (at 10 (image_available img22))
  (at 18 (not (image_available img22)))
  (at 31 (image_available img24))
  (at 39 (not (image_available img24)))
  (at 1 (dump_available))
